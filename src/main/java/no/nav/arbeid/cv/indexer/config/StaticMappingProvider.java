...
public class StaticMappingProvider {
    ...
    public static final String CV_SETTINGS_CONFIG = "/no/nav/arbeid/cv/indexer/config/cv_settings.json";

    public static final String CV_MAPPING_CONFIG = "/no/nav/arbeid/cv/indexer/config/cv_mapping.json";
